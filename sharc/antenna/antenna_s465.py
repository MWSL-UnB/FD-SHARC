...
if __name__ == '__main__':
    ...
    plt.semilogx(phi, gain27 - param27.antenna_gain, "-b", label = "$D = 0.45$ $m$")
    plt.semilogx(phi, gain43 - param43.antenna_gain, "-r", label = "$D = 1.8$ $m$")
...
#    plt.title("ITU-R S.465-6 antenna radiation pattern")
    ...
    plt.grid()
    plt.savefig("s465_pattern.pdf", bbox_inches='tight')
    plt.show()
