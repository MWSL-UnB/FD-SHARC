...
param_list = [AntennaPar(False, None, "M2101", 5, 90, 90, 25, 25, 8, 8, 0.5, 0.5, 0),
              AntennaPar(False, None, "M2101", 5, 90, 90, 25, 25, 8, 16, 0.5, 0.5, 0)]
file_names = ['bs_indoor_norm_8x8.npz',
              'bs_indoor_norm_8x16.npz']
###############################################################################
## Setup
# General parameters
resolution = 2
